...
const T = {
  de: {
    ...
    mat: {
      ...
      p: 'APPOLOC nutzt Oberflächen, die nicht nur informieren, sondern auch auf die Raumwirkung einzahlen: mattes Linoleum, Holz, Moos, Leder, Tafel, Stein und ruhige Farben.',
      items: [
        { name: 'Linoleum', desc: 'matt · warm · ruhig' },
        ...
        { name: 'Stein', desc: 'ruhig · stabil · wertig' },
  ...
  en: {
    ...
    mat: {
      ...
      p: 'APPOLOC uses surfaces that not only inform but also contribute to room presence: matte linoleum, wood, moss, leather, blackboard, stone and calm colors.',
      items: [
        { name: 'Linoleum', desc: 'matte · warm · calm' },
        ...
        { name: 'Stone', desc: 'calm · stable · valuable' },
